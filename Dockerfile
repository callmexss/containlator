...
RUN apt-get -y update && apt-get install -y python3.7
RUN apt-get install -y iproute2 iputils-arping net-tools tcpdump curl telnet iputils-tracepath traceroute
